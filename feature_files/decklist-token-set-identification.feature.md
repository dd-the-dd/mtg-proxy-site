...
- Simulation board layout keeps the life totals, hand row, battlefield, and bottom phase controls compact enough for a two-player game to remain visible without an inner board scroll; hand cards and zone stacks can be smaller than battlefield permanents so the in-play cards remain readable.

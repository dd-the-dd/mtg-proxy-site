...
- Value analysis for damage-based removal spells, such as Abrade, shows per-meta-deck battlefield removal coverage under the cast option, including removed and affected percentages plus collapsible target details and protection responses.

...
- The main workspace includes a Play setup screen that can choose a tagged meta deck as the default matchup, configure player count, each player's deck, human or AI roles, opponent hand visibility, play speed, and board zoom before the board is shown.

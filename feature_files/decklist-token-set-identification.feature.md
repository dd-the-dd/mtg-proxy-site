...
- Simulation player settings include a deck selector per player; the current loaded deck can be assigned to any player, every tagged meta session is available as a player deck choice, and unset opponents fall back to the selected matchup deck.
